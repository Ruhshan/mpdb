...
async def get_guide():
    guides = [
        ...
        Guide(id=3,
              ...
              imageUrl="https://i.postimg.cc/tC8xyxjg/ss3.jpg"),
        Guide(id=4,
              ...
              imageUrl="https://i.postimg.cc/05B6dwrC/ss4.jpg"),
        Guide(id=5,
              text="The user can search using active compound name to look up all plant entries containing that specific active compound.",
              imageCaption="User can search using active compounds",
              imageUrl="https://i.postimg.cc/9X68M1y3/ss5.jpg"),
        Guide(id=6,
              ...
              imageCaption="User can search using ailments",
              imageUrl="https://i.postimg.cc/7LZXcRrz/ss6.jpg"),
        Guide(id=7,
              ...
              imageCaption="User can search with utilized parts",
              imageUrl="https://i.postimg.cc/D0LcLkL9/ss7.jpg"),
        Guide(id=8,
              text="The user can also implement Boolean search utilizing multiple keywords with AND/OR.",
              imageCaption="User can use Boolean search too",
              imageUrl="https://i.postimg.cc/mg2Q2Fpf/ss8.jpg"),
        Guide(id=9,
              text="In case of multiple PMID, if the user clicks on the PMID section, a separate pop up window will show which active compound of the respective plant have been recorded in which publication.",
              imageCaption="Modal can show references for multiple PMID",
              imageUrl="https://i.postimg.cc/pd55pQD7/ss9.jpg"),
