...
async def get_guide():
    guides = [
        ...
        Guide(id=3,
              ...
              imageUrl="https://i.postimg.cc/26N8MHzr/ss3.png"),
        Guide(id=4,
              ...
              imageUrl="https://i.postimg.cc/NMtBp540/ss4.png"),
        Guide(id=5,
              ...
              imageUrl="https://i.postimg.cc/CL9ycRMV/ss5.png"),
        Guide(id=6,
              ...
              imageUrl="https://i.postimg.cc/qR1SyRDS/ss6.png"),
        Guide(id=7,
              ...
              imageUrl="https://i.postimg.cc/c4g2tdRk/ss7.png"),
        Guide(id=8,
              text="In case of multiple PMID, if the user clicks on the PMID section, a sperate pop up window will show which active compound of the respective plant have been recorded in which publication.",
              imageCaption="Modal can show references for multiple PMID",
              imageUrl="https://i.postimg.cc/26y2pxT9/ss8.png"),
        Guide(id=9,
              ...
              imageCaption="Advanced search is not yet supported",
              imageUrl="https://i.postimg.cc/L4YFLkRV/ss9.png"),
