...
async def get_publications():
    publications = [{'id': 1, 'title': 'MPD3: a useful medicinal plants database for drug designing',
                     'link': 'https://www.tandfonline.com/doi/abs/10.1080/14786419.2016.1233409'},
                    {'id': 2, 'title': 'A Brief Review of Traditional plants as Sources of Pharmacological interests',
                     'link': 'https://www.peertechzpublications.com/articles/OJPS-4-115.pdf'},
                    {'id': 3,
                     'title': 'In vitro Membrane Stabilizing and In vivo Analgesic Activities of Boehmeria glomerulifera Miq. in Swiss-Albino Mice Model',
                     'link': 'https://www.banglajol.info/index.php/BPJ/article/view/29278'},
                    {'id': 4,
                     'title': 'Analgesic and anti-diarrheal activities of Aganosma dichotoma (Roth) K. Schum. in Swiss-albino mice model ',
                     'link': 'https://www.banglajol.info/index.php/BPJ/article/view/23507'},
                    {'id': 5,
                     'title': 'ANTIOXIDANT, CYTOTOXIC, SEDATIVE AND ANTI-DIURETIC EFFECTS OF STEM AND ROOT EXTRACTS OF BASAK, ADHATODA VASICA'.title(),
                    ...
                    {'id': 6, 'title': 'Anti-Diabetic and Bronchodilator Activities of Pothos scandens Linn Leaves',
                     'link': 'http://impactfactor.org/PDF/IJPPR/7/IJPPR,Vol7,Issue6,Article27.pdf'},
                    {'id': 7,
                     ...
                     'link': 'https://www.mdpi.com/1420-3049/25/17/3936'},
                    {'id': 8, 'title': 'MPB 3.1: A Useful Medicinal Plants Database of Bangladesh',
                     'link': 'https://scienceq.org/wp-content/uploads/2020/07/JALSV8I102.pdf'},
                    {'id': 9,
                     'title': 'PHYTOCHEMICAL SCREENING, ANTIBACTERIAL, THROMBOLYTICAND ANTI-INFLAMMATORY ACTIVITIES OF STEM AND ROOT EXTRACTS OF BASAK, ADHATODA VASICA'.title(),
                    ...
                    {'id': 10, 'title': 'CDK4 as a phytochemical based anticancer drug target',
                     'link': 'https://www.biorxiv.org/content/10.1101/859595v1.abstract'},
                    {'id': 11,
                     'title': 'Therapeutic effects  of ethnomedicinal  plants  used  against  various  diseases  in Bangladesh',
                     'link': 'http://ijnss.org/wp-content/uploads/2018/03/IJNSS-V5I1-08-pp-52-58.pdf'},
                    {'id': 12,
                     'title': 'SCREENING OF BIOACTIVITIES OF METHANOL EXTRACTIVESFROM AERIAL PARTS OFNAYANTARA(CATHARANTHUS ROSEUS)'.title(),
                    ...
                    {'id': 13,
                     'title': 'Medicinal plants for gastrointestinal diseases among the Kuki-Chin ethnolinguistic groups across Bangladesh, India, and Myanmar: A comparative and network analysis study',
                     'link': 'https://www.sciencedirect.com/science/article/abs/pii/S0378874119315454'},
                    {'id': 14,
                     ...
                     'link': 'http://dspace.bracu.ac.bd/xmlui/handle/10361/9357'},
                    {'id': 15, 'title': 'Phytochemicals as Potential Anticancer Drugs: Time to Ponder Nature’s Bounty',
                     'link': 'https://www.hindawi.com/journals/bmri/2020/8602879/'},
                    {'id': 16,
                     'title': 'The Powerful Healing Effect of Traditional Medicine for The Treatment of Certain Chronic Diseases: One of The Means To Better Defeat Covid-19 ',
                     'link': 'http://jbarbiomed.com/index.php/home/article/view/57'},
                    {'id': 17, 'title': 'Bioinformatics-assisted, integrated omics studies on medicinal plants ',
                     'link': 'https://academic.oup.com/bib/article-abstract/21/6/1857/5627745'},
                    {'id': 18,
                    ...
                    {'id': 19,
                     'title': 'Analgesic, Antidiarrheal and Antidepressant Activities of Anethum sowa Linn. in Swiss-Albino Mice Model ',
                     'link': 'https://www.banglajol.info/index.php/BPJ/article/view/37899'}
                    ]
    return publications
